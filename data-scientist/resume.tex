...
\section{\Large{Experience}}
  \resumeSubHeadingListStart
    \resumeSubheadingNoItalics
      {\large AI Enablement Intern}{February 2026 -- Currently}
      {\href{https://micron.com}{\textcolor{BlueViolet}{\textbf{\large{Micron}}}}}{Guadalajara, México}
      \resumeItemListStart
    ...
    %     \resumeItemNoBullet{\textbf{Key Metrics:} Optimized \textbf{hardware-software integration} by modifying \textbf{C++} drivers to synchronize visual-inertial sensors and control UAV kinematics.}
    %   \resumeItemListEnd
...
\section{\Large{Education}}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Implementing and optimizing custom LSTM architectures for time-series forecasting using PyTorch and Python. Focus on improving computational efficiency and long-term dependency retention.}
      \resumeItemListEnd
    \resumeSubheading
      {University of Guadalajara}{Guadalajara, México}
